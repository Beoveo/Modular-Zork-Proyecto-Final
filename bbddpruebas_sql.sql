...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2019 a las 17:29:40
...
(1, 'hacha', 'armas', 10, 10, 10, 10, '\\img\\hacha.jpg');
...
(1, 'troll', 10, 10, 10, 10, '\\img\\monstruo.jpg');
...
(11, 'map1', 1, 1, 2, 10, '', 1, 'img\\mapa.jpg', 'Mapa 1', 5, 0, 0);
...
(1, 'm1', 1, 1, 5, 'img\\mapa.jpg', 'Bienvenido a la mazmorra 1'),
(2, 'm2', 1, 0, 5, 'img\\mapa.jpg', 'Bienvenido a la mazmorra 2');
...
(1, 'yo', 'yo@yo.com', 'usuario', 100, 0, NULL, b'0');
...
--
ALTER TABLE `mapas`
  MODIFY `idMapa` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
