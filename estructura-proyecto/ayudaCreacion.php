...
<body>
	...
	<?php $app->doInclude('comun/cabecera.php');?>
		...
		<?php $app->doInclude('comun/sidebarIzq.php');?>
			<div id="contenido">
			<h2>Comienzo</h2>
				<p>Una vez estemos en la pantalla de <a href ='creacion.php'>Creación</a> seleccionamos en las distintas pantallas, monstruos y objetos que queremos añadir en nuestro mapa.</p>
					<p></p>
				<h2>Edición</h2>
