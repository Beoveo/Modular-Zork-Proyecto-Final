...
--
-- Servidor: localhost
-- Tiempo de generación: 05-05-2019 a las 18:55:05
...
CREATE TABLE `rooms2` (
  ...
  `pickUp` varchar(200) COLLATE utf8mb4_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `rooms2` (`idRoom`, `nivel`, `nameRoom`, `description`, `direccion`, `destino`, `imagen`, `pickUp`) VALUES
...
(3, 0, 'gransala', 'Estas en una gran sala, al fondo una anciana abre una puerta y te da una pocion . Que haces?', 'south', 'room1', 'zork/juegoimg/p2/salaSupClabozo.png', 'pocion'),
