...
<body>
	<div id="contenedor">
		...
		<div id="contenido">
			...
			<div id="mapas">
				<a href="tiendaSeccion.php?type=mapas" class="enlTienda"><h1>Mapas</h1></a>
			...
			<div id="enemigos">
				<a href="tiendaSeccion.php?type=enemigo" class="enlTienda"><h1>Enemigos</h1></a>
			...
			<div id="personajes">
				<a href="tiendaSeccion.php?type=personaje" class="enlTienda"><h1>Personajes</h1></a>
			...
			<div id="objetos">
				<a href="tiendaSeccion.php?type=consumibles" class="enlTienda"><h1>Objetos</h1></a>
