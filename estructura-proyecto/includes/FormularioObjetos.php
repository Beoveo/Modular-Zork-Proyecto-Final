    ...
    $camposFormulario=<<<EOF
		<fieldset>
		  <legend>Añade el Objeto</legend>
            <p><label>Tipo:</label> <input type="text"        name="name" placeholder="$name"/></p>
		  <p><label>Nombre:</label> <input type="text" name="username" placeholder="$username"/></p>
		  <p><label>Caracteristicas: </label> <input type="password" name="password"/><br /></p>
          <p><label>Descripcion: </label> <input type="password" name="password2" /><br /></p>
