<div id="contenidocreacion">
	...
	<div id="eligemapa">
		...
		<center>
			...
			<a href="creacion.php" class="button" >1</a>
			<a href="creacion.php" class="button" >2</a>
			<a href="creacion.php" class="button" >3</a>
			<a href="creacion.php" class="button active" >...</a>
		</center>
	</div>
	...
	<center>
		<div id="contenidoboton">
			<form action="creacion1.php" method="POST">
